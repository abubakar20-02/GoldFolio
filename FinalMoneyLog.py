...
class Ui_Form(QObject):
    ...
    def Search(self):
        ...
        self.line("Change", StartDate=StartDate, EndDate=EndDate)
    ...
    def checkIfCustom(self):
        ...
        if self.PresetComboBox.currentIndex() != 4:
            ...
            self.line("Change", StartDate=today - timedelta(days=timedelta1), EndDate=today)
            print("work")
    ...
    def line(self, ValueSelect="Money", StartDate=None, EndDate=None):
        ...
        if StartDate is not None and EndDate is not None:
            ...
            #     multiples_of_7 = [number for number in x if number % 7 == 0]
            #     self.canvas.axes.set_xticks(multiples_of_7)
            #     self.canvas.axes.set_xticklabels(multiples_of_7, rotation=45)
